...
import { Flame, Dumbbell, Weight, Trophy, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      {Object.keys(stats.totalWeightByYear).length > 1 && (
        <Card>
          <h2 className="mb-3 text-sm font-semibold text-surface-500">Volume by Year</h2>
      ...
      <Card>
        <div className="mb-3 flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-surface-500">Per Exercise — {TIME_LABELS[range]}</h2>
        </div>
